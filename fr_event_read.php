		...
		<div class="span10 offset1">
			...
			<div class="form-horizontal" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo Functions::dayMonthDate($data['order_date']);?>
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo Functions::timeAmPm($data['order_time']);?>
						</label>
					</div>
				</div>
			...
			<?php
				$pdo = Database::connect();
				$sql = "SELECT * FROM fr_assignments, delivery_person WHERE assign_per_id = delivery_person.id AND assign_event_id = " . $data['id'] . ' ORDER BY lname ASC, fname ASC';
				$countrows = 0;
