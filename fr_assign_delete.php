		...
		<div class="span10 offset1">
			...
			<div class="form-horizontal" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo trim($eventdata['order_description']) . " (" . trim($eventdata['order_address']) . ") ";?>
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo Functions::dayMonthDate($eventdata['order_date']) . ", " . Functions::timeAmPm($eventdata['order_time']);?>
						</label>
					</div>
				</div>
